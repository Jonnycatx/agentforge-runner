...
self.addEventListener('fetch', (event) => {
  ...
  // README
  const readme = `# ${agent.name || "AI Agent"} - PWA

Progressive Web App generated by AgentForge.

## How to Use

1. Open index.html in your browser (or use a local server)
2. Select your AI provider (OpenAI, Anthropic, Groq, Google, xAI, or Ollama)
3. Enter your API key (Ollama runs locally without a key)
4. Start chatting!
...
- ${agent.voiceEnabled ? "Voice input and text-to-speech enabled" : "Text-based chat"}
- Dark mode support
